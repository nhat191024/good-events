...
namespace App\Filament\Admin\Resources\DesignCategories\Tables;
        ...
        return $table
            ...
            ->recordActions([
                Action::make('manage-children-categories')
                    ...
                    ->url(fn($record): string => DesignCategoryResource::getUrl('children-categories', ['record' => $record->id]))
