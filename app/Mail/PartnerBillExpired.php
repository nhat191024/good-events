...
class PartnerBillExpired extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        ...
        $subject = __('emails.partner_bill_expired.subject', ['code' => $this->partnerBill->code]);
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'emails.partner-bill-expired',
            with: [
