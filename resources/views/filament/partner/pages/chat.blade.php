                        ...
                        <div class="{{ $message['user_id'] === auth()->id() ? 'justify-end' : 'justify-start' }} flex">
                            <div class="max-w-[70%]">
                                ...
                                @if (($message['type'] ?? 'text') === 'call')
                                    ...
                                    @endphp
                                    <div class="{{ $isOutgoingCall ? 'bg-primary-600 rounded-br-md text-white' : 'rounded-bl-md bg-gray-200 text-gray-900 dark:bg-gray-700 dark:text-white' }} flex min-w-56 items-center gap-3 rounded-2xl px-4 py-3 shadow-sm">
                                        <span class="{{ $isOutgoingCall ? 'bg-white/20' : 'bg-white dark:bg-gray-600' }} flex h-10 w-10 shrink-0 items-center justify-center rounded-full">
