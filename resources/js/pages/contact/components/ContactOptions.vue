    ...
    <section class="bg-white">
        <div class="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
            <div class="grid gap-6 lg:grid-cols-3">
                <motion.article v-for="(channel, index) in channels" :key="channel.title"
                    ...
                    :transition="getCardTransition(index)" :while-hover="cardInteractions.hover"
                    ...
                    <div v-if="channel.action" class="mt-6">
                        <Link :href="channel.action.route"
                            class="inline-flex items-center justify-center px-4 py-2 text-sm font-semibold text-white transition-all bg-indigo-600 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
