...
const socialLinks = [
    ...
    { label: 'Zalo', href: 'https://zalo.me', icon: 'zalo' },
];
...
<template>
    <footer class="bg-[#0D308C] text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            >
                                <svg v-if="social.icon === 'facebook'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M13.5 9.5V7.75c0-.8.4-1.5 1.7-1.5h1.3V3h-2.2C11.6 3 10 4.8 10 7.4V9.5H8v2.9h2V21h3.5v-8.6h2.3l.2-2.9H13.5Z" />
                                </svg>
                                <svg v-else-if="social.icon === 'tiktok'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M19.2 8.1c-1.1-.4-2-1.2-2.5-2.3h-.2v9.5c0 2.9-2.3 5.2-5.2 5.2S6 18.2 6 15.3c0-2.9 2.3-5.2 5.2-5.2.3 0 .7 0 1 .1v3A2.2 2.2 0 0 0 9 15.3c0 1.2 1 2.2 2.3 2.2 1.2 0 2.2-1 2.2-2.2V3h3.5c.2 1.2 1 2.2 2.2 2.7v2.4Z" />
                                </svg>
                                <svg v-else-if="social.icon === 'youtube'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M22 7.3c-.2-1-.9-1.8-1.9-2C18.1 5 12 5 12 5s-6.1 0-8.1.3c-1 .2-1.7 1-1.9 2C1.7 9 1.7 12 1.7 12s0 3 .3 4.7c.2 1 .9 1.8 1.9 2C5.9 19 12 19 12 19s6.1 0 8.1-.3c1-.2 1.7-1 1.9-2 .3-1.7.3-4.7.3-4.7s0-3-.3-4.7ZM10 15.2V8.8l5.3 3.2-5.3 3.2Z" />
                                </svg>
                                <svg v-else-if="social.icon === 'zalo'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M18.5 2H5.5A3.5 3.5 0 0 0 2 5.5v13A3.5 3.5 0 0 0 5.5 22h13a3.5 3.5 0 0 0 3.5-3.5v-13A3.5 3.5 0 0 0 18.5 2ZM8.3 15.4H5.7l2.8-4H5.9V9h4.1v2.1l-1.7 2.5Zm2.4 0V9h2v6.4Zm6 0-2.4-3v3h-2V9h1.9l2.3 2.8V9h2v6.4Z" />
                                </svg>
                            </a>
                        </div>
                        ...
                        <div class="space-y-3 text-sm leading-7">
                            <div class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M6.7 3.1 9 2c.8-.4 1.8 0 2 1l.5 2.2c.2.8 0 1.5-.5 2L9.7 8.5c1 1.9 2.6 3.5 4.5 4.5l1.2-1.3c.5-.5 1.2-.7 2-.5l2.2.5c1 .2 1.4 1.2 1 2l-1.1 2.3c-.4.8-1.2 1.3-2.1 1.2-3-.4-6-2-8.4-4.4-2.4-2.4-4-5.4-4.4-8.4-.2-.9.3-1.7 1.1-2.1Z" />
                                </svg>
                                <span>{{ settings.contact_hotline ?? '0393 719 095' }}</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2Zm0 2v.5l8 5 8-5V6H4Zm16 12V9.2l-7.4 4.6c-.4.3-.9.3-1.2 0L4 9.2V18h16Z" />
                                </svg>
            ...
            <div class="mt-10 flex flex-col items-center justify-between gap-4 rounded-2xl bg-white/10 px-5 py-4 backdrop-blur md:flex-row">
