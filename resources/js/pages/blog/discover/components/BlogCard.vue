<template>
    <motion.div class="h-full" :initial="cardMotion.initial" :while-in-view="cardMotion.visible"
        :viewport="cardMotion.viewport" :transition="cardMotion.transition" :while-hover="cardInteractions.hover"
        :while-tap="cardInteractions.tap">
        <Link :href="detailHref" class="h-full group relative block overflow-hidden rounded-xl md:rounded-3xl"
            :class="variantClass">
            ...
            <div
                class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent transition duration-500 group-hover:from-black/70" />
                ...
                <div v-if="showLocationMeta" class="flex flex-wrap gap-2 text-xs text-white/80">
                    ...
                    <span v-if="capacityLabel"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="h-4 w-4 text-primary-200">
