    ...
    >
        ...
        >
            ...
            <div class="relative aspect-[4/5] w-full overflow-hidden">
                ...
                <!-- Overlay Gradient -->
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-60 transition-opacity duration-300 group-hover:opacity-70"></div>

                <!-- Play Button Overlay -->
                <div class="absolute inset-0 flex items-center justify-center">
                    <div class="flex h-16 w-16 items-center justify-center rounded-2xl bg-white/20 backdrop-blur-sm transition-transform duration-300 group-hover:scale-110">
                ...
                <div class="absolute right-4 top-4">
                    <span class="rounded-lg bg-black/50 px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-white backdrop-blur-md">
                        Video
                    </span>
                </div>
                ...
                <div class="absolute bottom-0 left-0 right-0 p-6 text-white">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <!-- Category Badge -->
                        <div v-if="blog.category?.name" class="rounded-xl bg-red-500 px-3 py-2 text-xs font-bold uppercase tracking-wide text-white">
                            {{ blog.category.name }}
                        </div>
