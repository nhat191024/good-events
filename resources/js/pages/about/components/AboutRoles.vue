        ...
        <div class="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                <div class="space-y-3">
                    ...
                    <p class="max-w-2xl text-base text-slate-200/80">
                        Lướt nhanh qua hai hành trình trọng tâm của Sukientot.com: khách hàng đặt lịch tức thì và nhân sự nhận show đều đặn.
                    </p>
                </div>
                <div class="flex flex-wrap gap-2 text-sm text-slate-200/80">
                    <span class="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-2">
            ...
            <div class="mt-10 grid gap-4 lg:grid-cols-[1.05fr,0.95fr]">
                <motion.article
                    ...
                    :class="role.emphasis ? 'ring-2 ring-sky-300/60' : 'ring-1 ring-white/10'"
                    :style="{
                ...
                >
                    <div class="absolute inset-0 bg-gradient-to-t from-slate-950/70 via-slate-900/30 to-slate-900/10 transition duration-300 group-hover:from-slate-950/80 group-hover:via-slate-900/40 group-hover:to-slate-900/15" />
                    <div class="relative flex h-full flex-col justify-between p-7 sm:p-8">
                        <div class="space-y-4">
                            <div class="flex items-center gap-3">
                                <span class="inline-flex items-center rounded-full bg-white/15 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-sky-50">
                                    {{ role.badge }}
                                </span>
                                <span v-if="role.emphasis" class="inline-flex items-center rounded-full bg-amber-400/90 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-amber-900">
                                    Ưu tiên
                                </span>
                            </div>
                            <div class="space-y-2">
                        ...
                        <div class="mt-6 flex items-center justify-between">
                            ...
                            <span class="rounded-full bg-white/10 px-3 py-2 text-xs font-semibold uppercase tracking-wide text-slate-100/80">
                                {{ role.slug === 'client' ? 'Ưu tiên hiển thị' : 'Dành cho đối tác' }}
                            </span>
                        </div>
                    </div>
                </motion.article>
