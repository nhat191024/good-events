        ...
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1 text-white">
            <div class="flex items-center gap-2 mb-1">
              ...
              <span v-if="user.is_pro" class="px-2 py-0.5 bg-white/20 backdrop-blur-sm text-white text-xs rounded border border-white/30">
                Đã xác minh
              </span>
            </div>
          ...
          <div class="flex items-center gap-2">
            <button class="p-2 bg-white/10 backdrop-blur-sm hover:bg-white/20 rounded-lg border border-white/30 text-white transition-colors">
