            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 border rounded-2xl p-3 md:p-4 bg-white shadow-md">
                ...
                <div class="md:col-span-8 flex flex-col gap-1 p-3">
                    ...
                    <div class="mt-2 grid grid-cols-2 gap-3">
                        <Link v-if="props.item.slug && props.category?.slug" :href="route('quick-booking.fill-info', { partner_category_slug: props.category?.slug, partner_child_category_slug: props.item.slug })"
