<template>
  <div>
    ...
    <!-- Modal Overlay -->
    <div v-if="is_modal_open" @click="is_modal_open = false"
      class="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
      <div @click.stop class="relative max-w-5xl w-full max-h-[90vh] rounded-lg overflow-hidden bg-black">
        <button @click="is_modal_open = false"
        ...
        <!-- Image -->
        <ImageWithLoader :src="modalSrc" :alt="props.altText" class="w-full h-full"
