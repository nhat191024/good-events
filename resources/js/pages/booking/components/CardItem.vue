...
import RoundMedia from './RoundMedia.vue';
...
const iconComponent = computed(() => {
    if (!props.iconName) return icons.HelpCircle;
    const name = props.iconName.charAt(0).toUpperCase() + props.iconName.slice(1);
...
<template>
    <!-- large card -->
    <div
        class="items-center self-start flex gap-[10px] md:h-[361px] h-min relative p-0 text-decoration-none w-full hover:scale-105 transition-all">
        <div class="h-full relative w-[1px] grow shrink-0 basis-0">
            <div class="h-full w-full items-center flex flex-col gap-0 p-0 relative">
                <div
                    ...
                    <RoundMedia :src="getImg(props.cardImgSrc)" :fit="'cover'" :size="{ base: 60, sm: 90, md: 110 }"
                        ...
                        <div
                            ...
                            <component :is="iconComponent"
                                class="relative text-black md:w-[69px] md:h-[69px] w-[39px] h-[39px] stroke-primary-800" />
                        </div>
                    </RoundMedia>
                    ...
                    <div
                        ...
                        <div
                            class="outline-0 flex flex-col shrink-0 transform-none grow-0 basis-auto h-fit relative text-wrap w-full wrap-break-word">
                            <h3 v-text="props.title"
                                class="font-lexend text-black md:text-lg text-xs font-bold text-center z-[9]"></h3>
                        </div>
                    </div>
                    <div
                        class="items-center flex grow-0 shrink-0 basis-auto gap-[5px] h-min overflow-visible p-0 relative w-full">
                        <div
                            class="outline-0 flex flex-col justify-center shrink-0 transform-none grow-0 basis-auto h-auto relative text-wrap w-full break-words">
