            ...
            >
                ...
                <div class="max-h-96 overflow-y-auto">
                    ...
                    >
                        ...
                        <span>{{ emptyText }}</span>
                        <button
                            class="px-3 py-1.5 rounded-md border border-border text-xs hover:bg-muted transition-colors"
                            @click="$emit('reload')"
                        >
                            Tải lại
                        </button>
                    ...
                    <div v-else class="py-2">
                        ...
                        >
                            <div class="flex items-start gap-3">
                                <!-- Unread Indicator -->
                                <div
                                    class="mt-1.5 h-2 w-2 rounded-full flex-shrink-0 transition-opacity"
                ...
                <div
                    v-if="items.length > 0"
                    class="p-3 border-t border-border flex items-center gap-2 bg-background"
                >
                    <button
                        type="button"
